...
export default async function SeoAppliedValuesPage() {
  ...
  return <main className="min-h-screen bg-[#07070A]"><section className="container-feya pt-10 pb-16">
    <div className="mb-7 border-b border-[rgba(216,214,211,.12)] pb-7">
      <div className="eyebrow-gold mb-3">Админка · Применённые SEO-значения</div>
      <h1 className="text-bone text-[28px] font-medium leading-tight">Применённые SEO-значения</h1>
      <p className="mt-3 max-w-3xl text-[14px] leading-relaxed text-[var(--bone-dim)]">Внутренняя модель только для просмотра. Этот экран сам ничего не публикует на витрине.</p>
      <div className="mt-5 flex gap-3"><Link href="/admin/seo-change-sets" className="btn-ghost">Очередь SEO-правок</Link><Link href="/admin/seo-apply" className="btn-ghost">Создать SEO-правки</Link></div>
    </div>
    ...
    <div className="mb-8 grid grid-cols-3 gap-4">
      <div className="rounded-2xl border border-[rgba(216,214,211,.12)] bg-[rgba(255,255,255,.025)] p-5"><div className="eyebrow-dim mb-2">Строки</div><div className="text-bone text-[28px]">{rows.length}</div></div>
      <div className="rounded-2xl border border-[rgba(216,214,211,.12)] bg-[rgba(255,255,255,.025)] p-5"><div className="eyebrow-dim mb-2">Товары</div><div className="text-bone text-[28px]">{products.size}</div></div>
      <div className="rounded-2xl border border-[rgba(216,214,211,.12)] bg-[rgba(255,255,255,.025)] p-5"><div className="eyebrow-dim mb-2">Поля</div><div className="text-bone text-[28px]">{fields.size}</div></div>
    </div>
    <div className="rounded-2xl border border-[rgba(216,214,211,.12)] bg-[rgba(255,255,255,.025)] overflow-hidden">
      <div className="grid grid-cols-[1fr_.7fr_.8fr_1.4fr] gap-4 px-5 py-4 border-b border-[rgba(216,214,211,.10)] text-[10px] uppercase tracking-[0.22em] text-[var(--smoke)]"><div>Товар</div><div>Статус</div><div>Поле</div><div>Значение</div></div>
