  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_80%_0%,rgba(212,178,106,.13),transparent_32%),linear-gradient(180deg,#07070A,#111016_45%,#07070A)]">
    <section className="container-feya pt-10 pb-16">
      ...
      <div className="grid lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="rounded-2xl border border-[rgba(216,214,211,.12)] bg-[rgba(255,255,255,.025)] p-5"><div className="eyebrow-dim mb-3">На удержании</div><div className="font-price text-gold-grad text-[34px] leading-none">{shouldHold}</div><p className="mt-3 text-[12px] text-[var(--bone-dim)]">Спорные ключи нельзя использовать до проверки.</p></div>
      </div>
