...
export default async function SeoExportQueuePage() {
  ...
  const readyRows = approvedProducts.map((product) => ({ product, score: getSeoScore(product), draft: buildSeoDraftSuggestion(product) })).slice(0, 100);
