...
export function naturalKeywordPhrase(keyword: string): string {
  const reviewed: Record<string, string> = {
    'mens burning man costume': "men's burning man costume",
    'black and gold festival outfits': 'black and gold festival outfit',
    'costumes for drag queens': 'costume for drag queens',
