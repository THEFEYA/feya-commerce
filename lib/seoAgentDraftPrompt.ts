...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'Required generated left_description blocks: about_this_piece, why_youll_love_it, ideal_for, whats_included, material.',
    ...
    'Do not generate sizing_fit, production_timing, shipping_delivery, care, customization, returns_exchanges, or handmade_variation blocks. Those are canonical static right-panel/store-policy content.',
