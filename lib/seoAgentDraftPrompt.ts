...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'about_this_piece must be a complete 2-4 sentence editorial product story. Begin with the buyer’s approved occasion or need and a natural whole-product variation, not the exact H1 phrase. Then explain how a distinctive visible design choice changes the finished look and add one supported wear, material or finish value. It must not recap the deterministic What’s Included list, read like a visual inventory report, compare the design with generic/basic/plain clothing, or explain image coordinates.',
    ...
    'main_description must contain 45-75 words in 3-4 sentences. Identify our studio and original point of view, explain how our ideas help people find a design that feels personal, and connect this product to one supported setting.',
