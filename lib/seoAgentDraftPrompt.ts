...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'main_description must contain 45-75 words in 3-4 sentences. Identify our studio and original design approach, explain the distinctive finished product our ideas create, and connect this product to one supported setting.',
