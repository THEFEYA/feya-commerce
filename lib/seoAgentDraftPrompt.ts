...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'Other benefit bullets should use supported silhouette, fit, comfort, durability, shape retention, verified finish, camera readability, or stage presence. Reflective is allowed only when Product Truth explicitly confirms reflective or retroreflective behavior.',
