...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'Write like a skilled editor for an independent fashion studio: warm, concrete and persuasive, with varied sentence rhythm. Beauty must come from truthful product detail and buyer relevance, not hype, dry encyclopedia prose or abstract design jargon.',
    ...
    'Use the exact Primary phrase no more than four times across the complete generated pack. Reserve those placements for seo_title, H1, meta_description, and exactly one useful body passage, preferably About this piece. Do not repeat the exact Primary in ALT, Why you’ll love it, Ideal for, Designed for self-expression, or in both intro and About.',
    'When exact word order is awkward, use the nearest idiomatic inflection that keeps the same product meaning. Make the Primary whole-product concept the clearest recurring subject through natural whole-product references, not a density percentage, exact-match repetition, or synonym chains.',
    ...
    'about_this_piece must begin with the complete approved event or style look the buyer can create, then explain a supported product, wear, finish or design value. It must not recap the deterministic What’s Included list, read like a visual inventory report, or explain image coordinates.',
    ...
    'ideal_for must contain 3-5 concise buyer-readable bullets, aiming for 4-5 when the product supports them. Answer who wears the product and for which selected event, production or real context. Product Truth remains the veto.',
    ...
    'Ideal for may name general buyer roles such as performers, dancers, DJs, show artists, creators or stylists when they are compatible with the product type and supplied context. This never authorizes an unselected event, style, persona, cosplay or subculture keyword.',
...
function buildUserPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    h1EventRule,
    '- meta_description: concise whole-product identity, differentiator, and use case within the 158-character review cap. Do not spend snippet space repeating the full component inventory already shown by the configuration and What’s Included. No TheFEYA, source-language disclaimer, or padding to reach a minimum. Do not coordinate a finish with silhouette as if both were the same attribute.',
    ...
    '- Use the exact Primary phrase no more than four times across the complete generated pack. Reserve those placements for seo_title, h1, meta_description and exactly one useful body passage, preferably About this piece. Do not repeat it in ALT, Why you’ll love it, Ideal for, Designed for self-expression, or in both intro and About.',
    '- The Primary whole-product concept must remain the clearest recurring subject across title, H1, meta and useful body copy. There is no target keyword-density percentage: use idiomatic inflection and restrained semantic variation, never a synonym chain or repetition added merely to increase a count.',
    ...
    '- about_this_piece / left_description: a useful 2-4 sentence product story, usually 45-90 words. Start from the buyer job and complete approved product identity, then add supported design, wear, material or finish value in natural editorial prose. Do not merely restate the H1. Do not enumerate or paraphrase the component inventory: composition is already rendered deterministically in the configuration and What’s Included. A component term may appear only when it supports a new, concrete buyer benefit, never in “combines/pairs/brings together/includes X and Y” wording. Never report left/right position or what is visible from which angle. Do not use TheFEYA here.',
    '- why_youll_love_it / left_description: 3-4 non-duplicative purchase reasons. Exactly one may express studio design/authorship; every other bullet needs a different supported purchase, fit, comfort, repeat-use or visual outcome. Canonical right-panel facts may be translated into buyer value but their raw sentences must not be repeated. Do not use TheFEYA here.',
    ...
    '- ideal_for / left_description: 3-5 grounded bullets, aiming for 4-5 when compatible roles exist, answering who wears it and for which selected event, production or real context. Represent at least one value from each non-empty operator-selected event, style, persona and audience axis. Product-compatible general buyer roles may be used, but they must not introduce an unselected event, style, persona or subculture. Do not describe accents, silhouette, finish, construction, base layers, component combinations, or how an outfit is built. Do not use TheFEYA here.',
    '- main_description / left_description: heading must be Designed for self-expression. Use the single permitted TheFEYA mention here and immediately continue in first-person studio voice: “At TheFEYA, we…” or an equivalent first-person construction. Never begin “TheFEYA is”.',
