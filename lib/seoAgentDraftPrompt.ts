...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'Express the concept авторский дизайн in natural English as a studio-created design based on an original in-house concept, a signature studio design, or a design created in our studio. The vague phrase original design alone is not enough.',
    ...
    'why_youll_love_it must contain 3-5 concise benefit bullets from at least three distinct categories. Use no more than one bullet for studio-created, handmade, made-to-order, or not-mass-produced value because those are one idea.',
    'Other benefit bullets should use supported fit, comfort, durability, shape retention, reflective finish, camera readability, or stage presence.',
    ...
    'main_description must introduce TheFEYA once as a young independent team of designers and makers with original in-house ideas and a distinctive visual language.',
    'main_description must explain how we help performers, creators and festival buyers express individuality through clothing and build a memorable visual identity.',
    'main_description may say that a recognizable look can make photos, performances and social content more memorable and shareable and can support organic attention, reactions, saves and comments. It must not guarantee virality, popularity, likes, followers or any specific outcome.',
    'main_description may mention that our store offers a broad range of outfits for festivals, performances, photoshoots and other events, so buyers can choose a design matching their style or discuss a new idea with us.',
...
function buildUserPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    '- image_alt_candidates: visible product facts only. Use needs_image_review when uncertain.',
    ...
    '- why_youll_love_it / left_description: 3-5 non-duplicative benefits from at least three distinct categories. Only one design or handmade uniqueness point. Do not use TheFEYA here.',
    ...
    '- main_description must describe us as a young independent team of designers and makers, our original in-house ideas, our distinctive studio style, self-expression and a recognizable visual identity for festivals, stage, camera and social content.',
    '- main_description may say that a strong visual identity can make photos, performances and content more memorable and shareable and can support organic attention, reactions, saves and comments. Do not promise virality, popularity, likes, followers or guaranteed engagement.',
    '- main_description may mention that our store offers a broad range of outfits for festivals, performances, photoshoots and other events, so the buyer can choose a design matching their style or discuss a new idea with us.',
    '- main_description must explain what we can contribute through our ideas and design language, not repeat the product’s shoulder shape, fit, comfort, material or construction.',
    ...
    '- Post-apocalyptic, warrior, futuristic, Burning Man, stage, festival, glam, cyber, reflective, armor, and performance can be valid when supported.',
...
export function promptGuardrails(input?: SeoAgentInputContract) {
  return [
    ...
    'Non-guaranteed language about memorability, shareability, organic attention, reactions, saves and comments is allowed; promised virality or popularity is not.',
