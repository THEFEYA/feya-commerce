...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'Do not translate авторский дизайн into a bare internal-process phrase. Explain that our original ideas give the finished product a bold, recognizable and memorable character. Never compare it with a standard costume template.',
    ...
    'Use persuasive modifiers only when a supported fact earns them: striking, distinctive, glamorous, memorable, beautifully polished or keeps its shape beautifully. Empty superlatives remain filler.',
    'Finish wording follows confirmed color. Gold/silver may be polished and metal-inspired; black/red/white may be smooth, high-gloss and latex-like; holographic may be smooth, shiny and subtly color-shifting, never metallic.',
    'For holographic products, approved Secondary/support vocabulary may use mirror-look, reflective-inspired or sparkling-inspired once as an indirect aesthetic family. Never claim that the product material itself is reflective, retroreflective, mirrored or sparkling.',
    ...
    'about_this_piece must be a complete 2-4 sentence, 45-90 word editorial product story. Begin with the buyer’s approved occasion or need and a natural whole-product variation, not the exact H1 phrase. Then explain one distinctive design or exact color-aware finish and its concrete value. It must not recap the deterministic What’s Included list, read like a visual inventory report, compare the design with generic/basic/plain clothing, explain image coordinates, or add filler only to reach a word target.',
    ...
    'Include exactly one concrete studio-design differentiation benefit. Explain that our original design ideas give the finished outfit a distinctive, memorable character that feels personal. Do not compare it with standard templates, generic costumes or mass-produced work.',
    ...
    'Never write structured material. When supported, say that careful storage helps the piece keep its shape beautifully between wears and stay ready for future events.',
    'Never use full-length photos, full-body shots or another camera crop as a product benefit. A garment must not sound suitable only for one framing format; when supported, refer naturally to photographs, video, detail views or performance lighting.',
    'Comfort copy must name the confirmed material or garment as its subject and state a literal wearability outcome. Never write vague mechanisms such as “a comfortable feel supports” an event or performance.',
    ...
    'Under the Ideal for heading, lead each bullet with the person or role so it answers “for whom?” Vary the action verbs naturally; never repeat planning, preparing, choosing or another sentence frame across three or more bullets.',
    ...
    'Use credible, varied authorship language such as our designers, our fashion studio or our original design ideas. Do not repeat the bare adjective studio-designed across sections, and do not add subjective self-praise such as talented designers.',
    ...
    'main_description must contain 45-75 words in 3-4 sentences. Explain our original design purpose, individuality, creative freedom and memorable personal self-expression. Do not repeat product color, material, finish, comfort, components or construction.',
    ...
    'Never write visual identity, silhouette, starting point, final look open to your choices, final interpretation, or language implying that the sold garment is unfinished, transformable or awaiting a final version.',
...
function buildUserPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    '- Never say that an item keeps its shape during movement. Shape retention means keeping shape between wears, resisting creasing, storing better, or remaining reusable for future events.',
    '- Never write structured material. When supported, say that careful storage helps the piece keep its shape beautifully between wears and stay ready for future events.',
    '- Never use full-length photos, full-body shots or another crop as a product advantage. When camera value is supported, use inclusive language for photographs, video, detail views or performance lighting without implying that other framing is inferior.',
    '- Comfort copy must make the confirmed material or garment the subject and state a literal wearability outcome. Never write “a comfortable feel supports” an occasion or performance.',
    '- Do not repeat construction, structure or build across several Why bullets. One feature family may support only one bullet.',
    ...
    '- Ideal for must answer “for whom?” directly: begin each line with the person or role and vary the action verb. Never repeat planning, preparing, choosing or another sentence frame across three or more bullets.',
    ...
    '- Vary credible authorship language by product: our designers, our fashion studio or our original design ideas. Avoid repeating the bare adjective studio-designed and never use unsupported self-praise such as talented designers.',
    '- main_description must contain 45-75 words in 3-4 natural sentences. Explain our original design purpose, individuality, creative freedom and memorable personal self-expression. Do not repeat product color, material, finish, comfort, components or construction.',
    '- Use literal buyer language. Do not write visual identity, silhouette, structured material, starting point, final-version choices, visual noise, clarity of the look, point of view, considered appearance, expressive accent, intentional image or other abstract design-critique phrases.',
...
export function promptGuardrails(input?: SeoAgentInputContract) {
  return [
    ...
    'Designed for self-expression is a brand-mission close about original design purpose, individuality, creative freedom and memorable personal self-expression. Do not repeat product color, material, finish, comfort, components, construction or operational customization instructions.',
