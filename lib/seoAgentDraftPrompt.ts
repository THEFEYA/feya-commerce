...
function buildSystemPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    'main_description must explain how the studio helps performers, creators and festival buyers express individuality through clothing and build a memorable visual identity.',
    ...
    'Do not guarantee likes, followers, popularity, viral reach, press, sales, admiration, or audience reactions. You may say the work is designed to invite attention or stand out on stage and camera.',
...
function buildUserPrompt(input: SeoAgentInputContract) {
  ...
  return [
    ...
    '- main_description / left_description: heading must be Designed for self-expression. Use the single permitted TheFEYA mention here. Describe a young independent team of designers and makers, original in-house ideas, a distinctive studio style, self-expression and a memorable visual identity for festivals, stage and camera.',
    '- main_description must explain what the studio can contribute through its ideas and design language, not repeat the product’s shoulder shape, fit, comfort, material or construction.',
